---
title: 'Screen 0.5: PO/DU Login Design Specification'
document-type: screen-design
project: Procureline
pipeline: Procurement Officer
screen-number: 0.5
screen-name: PO/DU Shared Login
...
- '[[bmad-party-session-procurement-officer-screen-0-complete]]'
- '[[session-log-procurement-officer-screen-0-implementation-failures-and-redemption]]'
---
...
**Live Prototype**: [`screen-0.5-po-login.html`](../../../.superdesign/design_iterations/screen-0.5-po-login.html)

**Prototype Location**: `.superdesign/design_iterations/screen-0.5-po-login.html`

**Design Iteration**: See [[design-iterations-file-index]] → Procurement Officer Pipeline → Screen 0.5

**Related ADRs**:
- [[adr-index|ADR-002]] - 4-Layer Authentication System
- [[adr-index|ADR-008]] - Shared Login Screen Toggle
...
> **Architecture Decision**: See [[../../../02-Architecture/decisions/adr-index#ADR-008]] for the rationale behind our shared login screen with role toggle.
