...
async function main(): Promise<void> {
    ...
    const { runDepartmentUserStatusTrackingTests } = await import(
        "./department-user-status-tracking.test.js"
    );
    const { runDepartmentUserDashboardUiTests } = await import(
        "./department-user-dashboard-ui.test.js"
    );
    ...
    const { runProcurementOfficerSubmissionMonitoringTests } = await import(
        "./procurement-officer-submission-monitoring.test.js"
    );
    const { runProcurementOfficerRequestTests } = await import(
        "./procurement-officer-requests.test.js"
    );
    const { runProcurementOfficerReviewTests } = await import(
        "./procurement-officer-review.test.js"
    );
    const { runProcurementOfficerReviewDecisionTests } = await import(
        "./procurement-officer-review-decisions.test.js"
    );
    ...
    const completedTests = [
        ...
        ...runProcurementOfficerReviewDecisionTests(),
        ...runPlanRedraftTests(),
