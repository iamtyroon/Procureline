...
const Card = React.forwardRef(({ className, disabled, ...props }, ref) => ((0, jsx_runtime_1.jsx)("div", { ref: ref, className: (0, utils_1.cn)("rounded-xl border bg-card text-card-foreground shadow", disabled && "cursor-not-allowed text-muted-foreground", className), ...props })));
exports.Card = Card;
