...
async function completeInstitutionProfileForBackendTests(args) {
    ...
    if (args.fiscalYearStartMonth !== institutionalFiscalYearStartMonth) {
        backendError("VALIDATION_FAILED", "The institutional fiscal year is fixed from 1 July through 30 June.", "fiscalYearStartMonth");
    }
