...
export function ProcurementOfficerWorkspaceRouteRedirect({
    ...
    const targetHref = useMemo(
        () => resolveProcurementOfficerWorkspaceNavigation(href).href,
        [href],
    );
                ...
                <CardHeader className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <CardDescription className="text-sm leading-7">
                            This route should open inside the Procurement Officer dashboard shell. If the modal workspace
                            did not appear, retry the redirect or open the dashboard directly.
                        </CardDescription>
                    </div>
