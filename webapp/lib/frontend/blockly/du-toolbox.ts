import { buildCategoryToolboxStyle, type CategoryIconName } from "@/lib/procurement-officer/categories";
import {
    sanitizeDepartmentUserWorkspaceCategorySelection,
    type DepartmentUserUnavailableCategory,
    type DepartmentUserWorkspaceCategoryRecord as SharedDepartmentUserWorkspaceCategoryRecord,
    type DepartmentUserWorkspaceItemRecord,
} from "@/lib/shared/blockly/du-toolbox-selection";
...
export interface DepartmentUserWorkspaceCategoryRecord
    extends Omit<SharedDepartmentUserWorkspaceCategoryRecord, "icon"> {
    icon?: CategoryIconName | null;
}

export type {
    DepartmentUserUnavailableCategory,
